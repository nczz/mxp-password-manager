...
ob_start();
?>
<h2 style="margin: 0 0 24px; color: #111827; font-size: 20px; font-weight: 600; line-height: 1.4; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">您已獲得新的服務存取權限</h2>
...
<table class="details-table" width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width: 100%; margin: 24px 0; border-collapse: separate; border-spacing: 0; background-color: #ffffff;">
    <tr>
        <td class="details-label" valign="top" style="width: 100px; color: #6b7280; font-size: 14px; font-weight: 500; padding: 16px 16px 16px 0; border-bottom: 1px solid #f3f4f6; white-space: nowrap; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">授權者</td>
    ...
    <tr>
        <td class="details-label" valign="top" style="width: 100px; color: #6b7280; font-size: 14px; font-weight: 500; padding: 16px 16px 16px 0; border-bottom: none; white-space: nowrap; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">授權時間</td>
