...
ob_start();
?>
<h2 style="margin: 0 0 24px; color: #111827; font-size: 20px; font-weight: 600; line-height: 1.4; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">服務密碼已變更</h2>
...
<p style="margin: 0 0 24px; color: #4b5563; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6;">您有權存取的服務密碼已被變更：</p>

<div class="info-box warning" style="background-color: #fffbeb; border: 1px solid #fde68a; border-left: 4px solid #d97706; padding: 20px; margin: 24px 0; border-radius: 8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
...
<table class="details-table" width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width: 100%; margin: 24px 0; border-collapse: separate; border-spacing: 0; background-color: #ffffff;">
    <tr>
        <td class="details-label" valign="top" style="width: 100px; color: #6b7280; font-size: 14px; font-weight: 500; padding: 16px 16px 16px 0; border-bottom: 1px solid #f3f4f6; white-space: nowrap; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">變更者</td>
    ...
    <tr>
        <td class="details-label" valign="top" style="width: 100px; color: #6b7280; font-size: 14px; font-weight: 500; padding: 16px 16px 16px 0; border-bottom: none; white-space: nowrap; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">變更時間</td>
...
<p style="margin: 0 0 24px; color: #4b5563; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6;">請登入系統查看新的密碼資訊。</p>
